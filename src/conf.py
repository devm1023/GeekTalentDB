...
CANONICAL_DB  = 'postgresql://geektalent:geektalent@130.211.99.149/canonical_prod'
...
CAREERDEFINITION_DB \
    = 'postgresql://geektalent:geektalent@130.211.99.149/careerdefinition'

# Description Database
DESCRIPTION_DB \
        = 'postgresql://geektalent:geektalent@130.211.99.149/description'
...
ADZUNA_SEARCH_API = 'https://api.adzuna.com/v1/api/jobs/{}/search/'

# Indeed
INDEED_SEARCH_API = 'https://api.indeed.com/ads/apisearch'
INDEED_PUB_ID = 0
