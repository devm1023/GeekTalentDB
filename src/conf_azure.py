...
# Crawl Database
CRAWL_DB      = os.environ.get('CUSTOMCONNSTR_CRAWL')

# Parse Database
PARSE_DB      = os.environ.get('CUSTOMCONNSTR_PARSE')

# Datoin Database 
DATOIN_DB     = os.environ.get('CUSTOMCONNSTR_DATOIN')

# Canonical Database
CANONICAL_DB  = os.environ.get('CUSTOMCONNSTR_CANONICAL')

# Analytics Database
ANALYTICS_DB  = os.environ.get('CUSTOMCONNSTR_ANALYTICS')

# GeekMaps Database
GEEKMAPS_DB   = os.environ.get('CUSTOMCONNSTR_GEEKMAPS')

# Career Definition Database
CAREERDEFINITION_DB = os.environ.get('CUSTOMCONNSTR_CAREERDEFINITION')

# Description Database
DESCRIPTION_DB = os.environ.get('CUSTOMCONNSTR_DESCRIPTION')
