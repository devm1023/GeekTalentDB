...
def parse_subject(doc):
    ...
    subject['employed_furtherstudy'] = extract(doc, xp_subject_employed_furtherstudy, formatted_percentage)
    subject['employed_furtherstudy_rating'] = extract(doc, xp_subject_employed_furtherstudy_rating)
