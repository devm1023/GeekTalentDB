...
_columns = {
    'skills'     : (Skill.name, Skill.liexperienceCount, Skill.language),
    'titles'     : (Title.name, Title.liexperienceCount, Title.language),
    'companies'  : (Company.name, Company.liexperienceCount, Company.language),
